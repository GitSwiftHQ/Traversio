...
func transportProtocolClientDefaultIdentificationMatchesReleaseVersion() {
    #expect(TraversioRelease.version == "1.0.5")
    #expect(TraversioRelease.sshSoftwareVersion == "Traversio_1.0.5")
    #expect(TraversioRelease.sshIdentificationRawValue == "SSH-2.0-Traversio_1.0.5")
