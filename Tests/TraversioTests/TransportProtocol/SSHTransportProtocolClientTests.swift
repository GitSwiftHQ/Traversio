...
func transportProtocolClientDefaultIdentificationMatchesReleaseVersion() {
    #expect(TraversioRelease.version == "1.0.4")
    #expect(TraversioRelease.sshSoftwareVersion == "Traversio_1.0.4")
    #expect(TraversioRelease.sshIdentificationRawValue == "SSH-2.0-Traversio_1.0.4")
