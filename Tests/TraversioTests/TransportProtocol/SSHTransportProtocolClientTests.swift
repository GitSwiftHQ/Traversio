...
func transportProtocolClientDefaultIdentificationMatchesReleaseVersion() {
    #expect(TraversioRelease.version == "1.0.8")
    #expect(TraversioRelease.sshSoftwareVersion == "Traversio_1.0.8")
    #expect(TraversioRelease.sshIdentificationRawValue == "SSH-2.0-Traversio_1.0.8")
